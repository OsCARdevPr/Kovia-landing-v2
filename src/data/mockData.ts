...
export const CONSENT_COPY = {
  title: "Cookies y medicion",
  description:
    "Usamos cookies para medir y optimizar el rendimiento. Puedes aceptar o rechazar el uso de cookies no esenciales.",
  acceptLabel: "Aceptar",
...
export const NAVBAR_CTA_COPY = {
  fullLabel: "Diagnostico Gratis",
  shortLabel: "Cita",
} as const;
